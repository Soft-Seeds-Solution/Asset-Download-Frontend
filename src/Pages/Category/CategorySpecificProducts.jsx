...
export default function CategorySpecificProducts() {
    ...
    return (
        <>
            <Container>
                <Row>
                    <h4 className='py-3' style={{ color: "white", opacity: ".7" }} >Category : {category}</h4>
                    {products?.filter(product => product.categoryId?.category === productCategory).map((product, ind) => (
                        <Col md={3} key={ind}>
